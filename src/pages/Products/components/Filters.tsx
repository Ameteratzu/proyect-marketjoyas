...
const FilterOption = ({ label, className = '' }: { label: string; className?: string }) => {
  return (
    <button className={`border border-gray-300 rounded-md text-[15px] text-gray-700 hover:bg-gray-100 transition-colors flex items-center pl-2 ${className}`}>
      {label}
    </button>
  );
};
  ...
  return (
    ...
    <div className="flex w-full "> 
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mb-3">
          {/* Tamaño del texto cambiado a 25px */}
          ...
          <button className="w-full bg-primary cursor-pointer text-white font-sans py-2 rounded-md hover:opacity-90 transition-opacity">
            Actualizar
          </button>
        </div>
        ...
        <div className="mb-3">
          ...
          <div className="flex flex-col gap-1">
            {/* Se aplican clases de tamaño específicas para cada botón */}
      ...
      {/* Aquí irá el componente de la galería de productos */}
    </div>
  );
}